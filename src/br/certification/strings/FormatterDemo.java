...
public class FormatterDemo {
	...
	public static void main(String[] args) {
		...
		String greatingTemplate = "Hello, dear %s! Good %s!";
		String morning = "Morning";
		String everning = "Evening";
		
		String formatterGreating = greatingTemplate.formatted(morning, everning);
		
		System.out.println(formatterGreating);
